...
COMPONENT_SRCDIRS := drivers/src drivers/serial drivers/i2c finsh bsp lua lua/modules dfs
COMPONENT_ADD_LDFLAGS += $(COMPONENT_BUILD_DIR)/dfs/vi.o
COMPONENT_ADD_LDFLAGS += $(COMPONENT_BUILD_DIR)/bsp/tcpecho.o $(COMPONENT_BUILD_DIR)/bsp/netio.o $(COMPONENT_BUILD_DIR)/bsp/ping.o 
